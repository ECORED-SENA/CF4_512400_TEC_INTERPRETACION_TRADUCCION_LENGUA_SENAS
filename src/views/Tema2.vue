  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Lineamientos normativos de interpretación, traducción y discapacidad
    .row
      .col-12.bg-c7
      ...
      .col-md-7.col-lg-3.mb-4.mb-lg-0
        .tarjeta-avatar
          ...
          .tarjeta.color-secundario
            .p-4
              p.text-center.mb-0 #[b Tamaño del recurso.]
      .col-md-7.col-lg-3.mb-4.mb-lg-0
        .tarjeta-avatar
          img(src='@/assets/curso/tema2/img20.svg' alt='AvatarTop')
          .tarjeta.color-secundario
            .p-4
              p.text-center.mb-0 #[b Opciones de velocidad.]
      .col-md-7.col-lg-3.mb-4.mb-lg-0
        .tarjeta-avatar
          img(src='@/assets/curso/tema2/img21.svg' alt='AvatarTop')
          .tarjeta.color-secundario
            .p-4
              p.text-center.mb-0 #[b Tipos de conexión para preferencias de usuario.]
      .col-md-7.col-lg-3
        .tarjeta-avatar
          ...
          .row
            ...
            .col-lg-7
              ...
              ul.lista-ul.color-azul
                ...
                li.mb-0
                  i.lista-ul__vineta
                  | Seguir los códigos deontológicos.
                li.mb-0
                  i.lista-ul__vineta
                  | Seguir el código de vestuario.
                li.mb-0
                  i.lista-ul__vineta
                  | Cuadre en plano medio o plano medio largo.
                li.mb-0
                  i.lista-ul__vineta
                  | Buena iluminación, sin sombras en el fondo.
                li.mb-0
                  i.lista-ul__vineta
      ...
      .p-4.p-lg-5
        SlyderA(tipo="b")
          ...
          .row.align-items-center.m-1
            ...
            .col-lg-7
              figure
                img(src='@/assets/curso/tema2/img6.png', style="width:650px").m-auto
          .row.align-items-center.m-1
            .col-lg-5.mb-4.mb-lg-0
            ...
            .col-lg-7
              figure
                img(src='@/assets/curso/tema2/img7.png', style="width:650px").m-auto
          .row.align-items-center.m-1
            .col-lg-5.mb-4.mb-lg-0
              h4 Universal Subtitles
              p Herramienta web colaborativa de código abierto para subtitular cualquier video de plataformas como YouTube o Vimeo. Pueden realizarse traducciones de los subtítulos y descargarlos en formato SubRip (.srt).
            .col-lg-7
              figure
                img(src='@/assets/curso/tema2/img8.png', style="width:650px").m-auto
          .row.align-items-center.m-1
            .col-lg-5.mb-4.mb-lg-0
              h4 Lector inversivo
              p Hace parte de la herramienta Teams Microsoft, con técnicas para mejorar la lectura y escritura para PC Windows 10. Ofrece lectura en voz alta, línea focal, diccionario de imágenes, traductor, cambio de color de fondo, cambio del espaciado entre líneas y palabras, resaltar partes del fragmento oído y sílabas; separa sílabas del texto, señala sustantivos, verbos o adjetivos; trabaja con procesadores de texto como PDF, One Note y Word.
            .col-lg-7
              figure
                img(src='@/assets/curso/tema2/img9.png', style="width:650px").m-auto
          .row.align-items-center.m-1
            .col-lg-5.mb-4.mb-lg-0
              h4 ELAN
              p La transcripción de discursos en lengua de señas es una labor complicada. Por este motivo, ELAN es una herramienta tecnológica hecha para realizar dicha labor. Su arquitectura informática facilita que en una misma interfaz se articulen y gestionen archivos de video y de audio para que de esta manera se pueda realizar transcripciones escritas en una línea de tiempo.
            .col-lg-7
              figure
                img(src='@/assets/curso/tema2/img10.png', style="width:650px").m-auto
